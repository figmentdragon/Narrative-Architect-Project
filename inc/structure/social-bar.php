...
if ( ! function_exists( 'creativityarchitect_social_bar' ) ) {
	add_action( 'creativityarchitect_social_bar_action', 'creativityarchitect_social_bar' );
	function creativityarchitect_social_bar() {
		$socials_facebook_url  		=  creativityarchitect_get_setting( 'socials_facebook_url' );
		$socials_twitter_url   		=  creativityarchitect_get_setting( 'socials_twitter_url' );
		$socials_google_url    		=  creativityarchitect_get_setting( 'socials_google_url' );
		$socials_tumblr_url    		=  creativityarchitect_get_setting( 'socials_tumblr_url' );
		$socials_pinterest_url 		=  creativityarchitect_get_setting( 'socials_pinterest_url' );
		$socials_youtube_url   		=  creativityarchitect_get_setting( 'socials_youtube_url' );
		$socials_linkedin_url  		=  creativityarchitect_get_setting( 'socials_linkedin_url' );
		$socials_custom_icon_1  	=  creativityarchitect_get_setting( 'socials_custom_icon_1' );
		$socials_custom_icon_url_1  =  creativityarchitect_get_setting( 'socials_custom_icon_url_1' );
		$socials_custom_icon_2  	=  creativityarchitect_get_setting( 'socials_custom_icon_2' );
		$socials_custom_icon_url_2  =  creativityarchitect_get_setting( 'socials_custom_icon_url_2' );
		$socials_custom_icon_3  	=  creativityarchitect_get_setting( 'socials_custom_icon_3' );
		$socials_custom_icon_url_3  =  creativityarchitect_get_setting( 'socials_custom_icon_url_3' );
		$socials_mail_url     		=  creativityarchitect_get_setting( 'socials_mail_url' );
	?>
    <div class="creativityarchitect-social-bar">
    	<ul class="creativityarchitect-socials-list">
