...
if ( ! function_exists( 'creativityarchitect_get_defaults' ) ) {
	/**
	 * Set default options
	 *
	 */
	function creativityarchitect_get_defaults() {
		$creativityarchitect_defaults = array(
			'hide_title' => '',
			'hide_tagline' => true,
			'top_bar_width' => 'full',
		...
		return apply_filters( 'creativityarchitect_option_defaults', $creativityarchitect_defaults );
	}
}

if ( ! function_exists( 'creativityarchitect_get_color_defaults' ) ) {
	/**
	 * Set default options
	 */
	function creativityarchitect_get_color_defaults() {
		$creativityarchitect_color_defaults = array(
			...
			'blog_header_bgcreativityarchitect_color' => 'rgba(255,255,255,0)',
		...
		return apply_filters( 'creativityarchitect_color_option_defaults', $creativityarchitect_color_defaults );
	}
}
...
if ( ! function_exists( 'creativityarchitect_get_default_fonts' ) ) {
	 ...
	 */
	function creativityarchitect_get_default_fonts( $filter = true ) {
		$creativityarchitect_font_defaults = array(
			'font_body' => 'Open Sans',
			'font_body_category' => '',
		...
		if ( $filter ) {
			return apply_filters( 'creativityarchitect_font_option_defaults', $creativityarchitect_font_defaults );
		}

		return $creativityarchitect_font_defaults;
	}
}

if ( ! function_exists( 'creativityarchitect_spacing_get_defaults' ) ) {
	/**
	 ...
	 * @return array Option defaults.
	 */
	function creativityarchitect_spacing_get_defaults( $filter = true ) {
		$creativityarchitect_spacing_defaults = array(
			'top_bar_top' => '5',
			'top_bar_right' => '40',
			'top_bar_bottom' => '2',
			'top_bar_left' => '40',
		...
		if ( $filter ) {
			return apply_filters( 'creativityarchitect_spacing_option_defaults', $creativityarchitect_spacing_defaults );
		}

		return $creativityarchitect_spacing_defaults;
	}
}

if ( ! function_exists( 'creativityarchitect_get_default_color_palettes' ) ) {
	/**
	 * Set up our colors for the color picker palettes and filter them so you can change them.
	 *
	 */
	function creativityarchitect_get_default_color_palettes() {
		$palettes = array(
			'#fefefe',
			'#333333',
			'#585598',
		...
		return apply_filters( 'creativityarchitect_default_color_palettes', $palettes );
	}
}

if ( ! function_exists( 'creativityarchitect_typography_default_fonts' ) ) {
	/**
	 * Set the default system fonts.
	 *
	 */
	function creativityarchitect_typography_default_fonts() {
		$fonts = array(
			'inherit',
			'System Stack',
		...
		return apply_filters( 'creativityarchitect_typography_default_fonts', $fonts );
	}
}

define( 'creativityarchitect_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Kanit:100,100italic,200,200italic,300,300italic,regular,italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic|Open+Sans:300,300italic,regular,italic,600,600italic,700,700italic,800,800italic|Nunito:200,200italic,300,300italic,regular,italic,600,600italic,700,700italic,800,800italic,900,900italic' );
