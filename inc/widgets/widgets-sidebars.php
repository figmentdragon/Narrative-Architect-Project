 ...
 */
function creativityarchitect_remove_recent_comments_style() {
    add_filter('show_recent_comments_widget_style', '__return_false');
}

add_action('widgets_init', 'creativityarchitect_remove_recent_comments_style');

/**
 * Register Creativity Architect widget areas.
 *
 * @return void
 */
function creativityarchitect_widgets_init() {
    ...
    register_sidebar(array(
        'id' => 'sidebar',
        'name' => __('Primary Sidebar', 'creativityarchitect'),
        'description' => __('Sidebar appears next to content.', 'creativityarchitect'),
    ...
    register_sidebar(array(
        'id' => 'call2action',
        'name' => __('Footer Call to Action', 'creativityarchitect'),
        'description' => __('This "Call to Action" area appears after our content', 'creativityarchitect'),
    ...
    register_sidebar(array(
        'id' => 'newsletter',
        'name' => __('Newsletter', 'creativityarchitect'),
        'description' => __('Newsletter widget appears in footer section on every page.', 'creativityarchitect'),
    ...
    register_sidebar(array(
        'id' => 'footer',
        'name' => __('Footer', 'creativityarchitect'),
        'description' => __('Footer widget area', 'creativityarchitect'),
