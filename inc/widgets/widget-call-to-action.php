...
class Call_To_Action_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                ...
                __('Call to Action Widget', 'creativityarchitect'), // Name for this widget type.
                array('description' => __('A text widget with a Call to Action button.', 'creativityarchitect'),)// Option array passed to wp_register_sidebar_widget()
        );
    }
    ...
    public function form($instance) {
        ...
        $button_text = isset($instance['button_text']) ? $instance['button_text'] : __('Click Here', 'creativityarchitect');
        $button_link = isset($instance['button_link']) ? $instance['button_link'] : __('#', 'creativityarchitect');
        ?>
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'creativityarchitect'); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('content'); ?>"><?php _e('Content:', 'creativityarchitect'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('button_text'); ?>"><?php _e('Button Text:', 'creativityarchitect'); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('button_text'); ?>" name="<?php echo $this->get_field_name('button_text'); ?>" type="text" value="<?php echo esc_attr($button_text); ?>" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('button_link'); ?>"><?php _e('Button Link:', 'creativityarchitect'); ?></label>
