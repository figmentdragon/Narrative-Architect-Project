...
if ( ! function_exists( 'creativity_social_bar' ) ) {
	add_action( 'creativity_social_bar_action', 'creativity_social_bar' );
	function creativity_social_bar() {
		$socials_facebook_url  		=  creativity_get_setting( 'socials_facebook_url' );
		$socials_twitter_url   		=  creativity_get_setting( 'socials_twitter_url' );
		$socials_google_url    		=  creativity_get_setting( 'socials_google_url' );
		$socials_tumblr_url    		=  creativity_get_setting( 'socials_tumblr_url' );
		$socials_pinterest_url 		=  creativity_get_setting( 'socials_pinterest_url' );
		$socials_youtube_url   		=  creativity_get_setting( 'socials_youtube_url' );
		$socials_linkedin_url  		=  creativity_get_setting( 'socials_linkedin_url' );
		$socials_custom_icon_1  	=  creativity_get_setting( 'socials_custom_icon_1' );
		$socials_custom_icon_url_1  =  creativity_get_setting( 'socials_custom_icon_url_1' );
		$socials_custom_icon_2  	=  creativity_get_setting( 'socials_custom_icon_2' );
		$socials_custom_icon_url_2  =  creativity_get_setting( 'socials_custom_icon_url_2' );
		$socials_custom_icon_3  	=  creativity_get_setting( 'socials_custom_icon_3' );
		$socials_custom_icon_url_3  =  creativity_get_setting( 'socials_custom_icon_url_3' );
		$socials_mail_url     		=  creativity_get_setting( 'socials_mail_url' );
	?>
    <div class="creativity-social-bar">
    	<ul class="creativity-socials-list">
