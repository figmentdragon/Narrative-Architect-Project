...
if ( ! class_exists( 'THEMENAME_Customize' ) ) {
	...
	class THEMENAME_Customize {
		...
		public function register( $wp_customize ) {
			...
			include_once get_theme_file_path( 'inc/class-THEMENAME-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
