 ...
 */
function creativitycategorized_blog() {
	$category_count = get_transient( 'creativitycategories' );
	...
	if ( false === $category_count ) {
		...
		set_transient( 'creativitycategories', $category_count );
	}
 ...
 */
function creativityget_attachment_id_from_url( $attachment_url = '' ) {
	global $wpdb;
 ...
 */
function creativitycopyright_year( $atts ) {
	// Setup defaults.
	$args = shortcode_atts(
		[
			'starting_year' => '',
...
add_shortcode( 'creativitycopyright_year', 'creativitycopyright_year', 15 );
 ...
 */
function creativityget_custom_logo_url() {
