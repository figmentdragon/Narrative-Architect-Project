...
jQuery(document).ready(function ($) {
    ...
    $('.widget_themename-number-counter').one('inview', startKnob);
    ...
    $(window).load(function () {
        ...
        $(".themename-preloader").fadeOut("slow");
    });
    ...
    if($('body').hasClass('page-template-tpl-home')){
        $('#fullpage').fullpage({
            ...
            //Custom selectors
            sectionSelector: '.themename-main-section',
    ...
    function themenameFocusForce(focEl){
        var _doc = document;
        setTimeout( function() {
    ...
    $('body').on('click keypress','.btn-transparent-toggle', function(){
        ...
        $('.site-footer').addClass('scroll-show').addClass('fp-show');
        themenameFocusForce('.main-navigation ul li:first-child a');
    });
